...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> SAPPHIRE_ORE = registerBlock("sapphire_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.STONE)
                    .strength(2.3F).requiresCorrectToolForDrops().lightLevel((o)-> 7), UniformInt.of(1, 5)));

    public static final RegistryObject<Block> DEEPSLATE_SAPPHIRE_ORE = registerBlock("deepslate_sapphire_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE)
                    .strength(2.5F).requiresCorrectToolForDrops().lightLevel((o)-> 5), UniformInt.of(4, 6)));

    public static final RegistryObject<Block> NETHER_SAPPHIRE_ORE = registerBlock("nether_sapphire_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.NETHERRACK)
                    .strength(1.7F).requiresCorrectToolForDrops().lightLevel((o)-> 5), UniformInt.of(2, 7)));
