...
public class SillyArrow extends AbstractSillyArrow {
    private static final int EXPOSED_POTION_DECAY_TIME = 600;
    private static final int NO_EFFECT_COLOR = -1;
    private static final EntityDataAccessor<Integer> ID_EFFECT_COLOR = SynchedEntityData.defineId(SillyArrow.class, EntityDataSerializers.INT);
    private static final byte EVENT_POTION_PUFF = 0;
    private Potion potion = Potions.EMPTY;
    private final Set<MobEffectInstance> effects = Sets.newHashSet();
    private boolean fixedColor;

    public SillyArrow(EntityType<? extends Arrow> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public SillyArrow(Level pLevel, double pX, double pY, double pZ) {
        super(EntityType.ARROW, pX, pY, pZ, pLevel);
    }

    public SillyArrow(Level pLevel, LivingEntity pShooter) {
